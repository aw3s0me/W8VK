...
namespace VKClient.Views
{
    ...
    /// </summary>
    public sealed partial class FriendsViewPage : VKClient.Common.LayoutAwarePage
    {
        public FriendsViewPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            try
            {
                ...
                if (DataContext != null)
                {
                    ((FriendsViewModel)DataContext).User = new UserProfile { Uid = parameter };
                    ((FriendsViewModel)DataContext).LoadFriendsCommand.Execute(null);
                }
            }
            catch (Exception ex)
            {
